...
## Section 0 -- Client Classification (Run Before Document Inventory)

(Determine all three classifications before assessing document availability.
State the source of each classification and its confidence.)

### KYC Client Type
Current classification: {{individual-retail / corporate-business / trust-foundation / financial-institution / pep}}
Source: {{Orbis / company registrar / trust deed / client-stated from onboarding form}}
Confidence: {{confirmed-by-independent-source / confirmed-by-client-document / client-stated-unverified}}
Change from prior review: {{same / reclassification -- prior type was X / not applicable -- first review}}

### Segment
Current segment: {{smb / services / markets / banking}}
Source: {{internal records / onboarding form / relationship manager assignment}}
Confidence: {{confirmed / uncertain -- see data quality flag}}
Change from prior review: {{same / changed from X to Y / not applicable -- first review}}

### Size
Current size: {{large / medium / small}}
Source: {{Moodys / audited financial statements / Orbis extracts / client-stated}}
Confidence: {{confirmed / uncertain}}
Change from prior review: {{same / changed from X to Y / not applicable}}

### Derived Risk Rating
Risk rating (from segment + size via risk rating matrix): {{low / medium / high / edd-mandatory}}
Prior risk rating: {{value or "not recorded"}}
Risk rating change: {{same / increased / decreased / not determinable -- classification uncertain}}
Source: KYC Policy KnowledgePack risk rating matrix, section {{section reference if known}}

### PR/CR Cycle
Cycle frequency for this risk rating: {{annually / every 2 years / every 3 years / as defined in policy}}
Last review date: {{date or "none -- first review"}}
Current review date: {{today's date}}
Review status: {{on time / overdue by X months / early}}
Next review due: {{date}}

### KYC Due Diligence Tier (separate from risk rating)
Applicable KYC client type for rule lookup: {{the KYC client type above}}
Jurisdiction risk tier: {{low / medium / high / prohibited -- from Jurisdiction Risk Register}}
PEP overlay: {{applies / does not apply / not determined}}
Effective due diligence tier: {{sdd / standard / edd}}
